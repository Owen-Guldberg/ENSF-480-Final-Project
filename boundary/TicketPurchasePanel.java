...
public class TicketPurchasePanel extends JPanel {
    ...
    private void handlePurchase(boolean insuranceSelected, String cardNumber, String cvv, String promoCode) {
        ...
        TicketConfirmationPanel confirmationPanel = new TicketConfirmationPanel(paymentController, userEmail, flight.getFlightNum(), flight.toString(), selectedSeat, totalPrice, cardPanel, cardLayout);
